...
void Render::initTrigBuffers(TrigMesh * m)
{
  ...
  glBufferData(GL_ARRAY_BUFFER, nFloat * sizeof(GLfloat), v, GL_STATIC_DRAW);
  glEnableVertexAttribArray(vpos_location);
  glVertexAttribPointer(vpos_location, 3, GL_FLOAT, 0, 0, 0);
